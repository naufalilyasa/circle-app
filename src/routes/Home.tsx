...
function Home() {
  // const myIcon: IconProp = "fa-light fa-heart";
  return (
    <main>
      <div className="grid grid-cols-1 border-collapse">
        ...
        <div className="flex gap-5 p-5 items-center border-x-2 border-t-0 border-y-2 border-[#2c2c2c]">
          <Avatar className="w-12 h-12">
            <AvatarImage src="https://github.com/shadcn.png" />
            <AvatarFallback>test</AvatarFallback>
          </Avatar>
        ...
        <div className="flex gap-4 p-5 items-center border-x-2 border-t-0 border-y-2 border-[#2c2c2c]">
          <Avatar className="w-12 h-12">
            <AvatarImage src="https://github.com/shadcn.png" />
            <AvatarFallback>test</AvatarFallback>
          </Avatar>
